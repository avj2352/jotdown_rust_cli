...
use crate::features::misc::{gen_check_command, gen_move_command, gen_undo_command};
// handlers
...
use crate::facade::misc_handler::{handle_check_todo_task, handle_move_todo_task, handle_revert_todo_task};

const APP_DESCRIPTION: &str = "A modern Todo application with extra features!";
const VERSION: &str = "0.4.02";
